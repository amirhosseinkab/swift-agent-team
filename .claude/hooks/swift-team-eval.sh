...
views, async/await, actors, Foundation Models, MLX, Core ML, coremltools,
model conversion, Keychain, CryptoKit, biometric auth, App Store submission,
testing, or any iOS/macOS application code:

1. Delegate to the swift-lead agent
2. The swift-lead will determine which specialist agents are needed
3. Specialists: concurrency-specialist, coreml-specialist,
   foundation-models-specialist, on-device-ai-architect,
   mobile-a11y-specialist, swiftui-specialist, app-review-guardian,
   testing-specialist, swift-security-specialist
...
8. Do NOT convert or optimize ML models without coreml-specialist review
